...
hb.settings.max_bar_length = 220
...
hb.settings.pos_left.x = hb.load_setting("hudbars_pos_left_x", "number", 0.446)
hb.settings.pos_left.y = hb.load_setting("hudbars_pos_left_y", "number", 0.975)
hb.settings.pos_right.x = hb.load_setting("hudbars_pos_right_x", "number", 0.505)
hb.settings.pos_right.y = hb.load_setting("hudbars_pos_right_y", "number", 0.975)
...
if hb.settings.bar_type == "progress_bar" then
	hb.settings.start_offset_left.x = hb.load_setting("hudbars_start_offset_left_x", "number", -170)
	hb.settings.start_offset_left.y = hb.load_setting("hudbars_start_offset_left_y", "number", -88)
	hb.settings.start_offset_right.x = hb.load_setting("hudbars_start_offset_right_x", "number", 15)
	hb.settings.start_offset_right.y = hb.load_setting("hudbars_start_offset_right_y", "number", -87)
else
	...
	hb.settings.start_offset_right.x = hb.load_setting("hudbars_start_statbar_offset_right_x", "number", 20)
	hb.settings.start_offset_right.y = hb.load_setting("hudbars_start_statbar_offset_right_y", "number", -90)
end
hb.settings.vmargin  = hb.load_setting("hudbars_vmargin", "number", 37)
